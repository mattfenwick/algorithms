...
func RunBracketTests() {
	...
	Describe("GetLongTermCapitalGainsTax (total / ordinary)", func() {
		...
		It("0K/0K", func() {
			gomega.Expect(ltcgBrackets[0].GetLongTermCapitalGainsTax(0, 0)).To(gomega.BeEquivalentTo(&BracketTax{1, 0}))
		...
		It("10K/0K", func() {
			gomega.Expect(ltcgBrackets[0].GetLongTermCapitalGainsTax(0, 10_000)).To(gomega.BeEquivalentTo(&BracketTax{10_000, 0}))
			gomega.Expect(ltcgBrackets[1].GetLongTermCapitalGainsTax(0, 10_000)).To(gomega.BeEquivalentTo(&BracketTax{0, 0}))
			gomega.Expect(ltcgBrackets[2].GetLongTermCapitalGainsTax(0, 10_000)).To(gomega.BeEquivalentTo(&BracketTax{0, 0}))
		})
		It("10K/10K", func() {
		...
		It("10K/5K", func() {
			gomega.Expect(ltcgBrackets[0].GetLongTermCapitalGainsTax(5_000, 10_000)).To(gomega.BeEquivalentTo(&BracketTax{5_000, 0}))
			gomega.Expect(ltcgBrackets[1].GetLongTermCapitalGainsTax(5_000, 10_000)).To(gomega.BeEquivalentTo(&BracketTax{0, 0}))
			gomega.Expect(ltcgBrackets[2].GetLongTermCapitalGainsTax(5_000, 10_000)).To(gomega.BeEquivalentTo(&BracketTax{0, 0}))
		})
		It("100K/50K", func() {
