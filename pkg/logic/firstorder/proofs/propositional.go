		...
		RootProof("P <-> ~ ~ P",
			ArrowProof(P,
				...
				ArrowProof(Not(Not(P)),
					Reit(P),                // P
					IArrow(P, Not(Not(P))), // P -> ~ ~ P
				), // ~ ~ P -> ( P -> ~ ~ P )
				EOr(Not(P), Not(Not(P)), Arrow(P, Not(Not(P)))), // P -> ~ ~ P
				EArrow(P, Not(Not(P))),                          // P
			),
			ArrowProof(Not(Not(P)),
				ContraProof(Not(P),
					Reit(Not(Not(P))),
		...
		RootProof("( ( P <-> Q ) <-> R ) <-> ( P <-> ( Q <-> R ) )",
			ArrowProof(DArrow(DArrow(P, Q), R),
				...
				ContraProof(Not(Arrow(P, DArrow(Q, R))),
					...
					EArrow(Not(R), Not(DArrow(P, Q))),      // ~ ( P <-> Q )
			...
			ArrowProof(DArrow(P, DArrow(Q, R)),
				...
				ContraProof(Not(Arrow(DArrow(P, Q), R)),
					...
					EArrow(Not(P), Not(DArrow(Q, R))),      // ~ ( Q <-> R )
					BiconditionalNegationTheorem(Q, R),     // Q <-> ~ R
					EDArrow(Q, Not(R), false),              // ~ R -> Q
					EArrow(Not(R), Q),                      // Q
					EDArrow(P, Q, false),                   // Q -> P
	...
	NewProofsSection("distributivity",
		...
		RootProof("( P ^ ( Q ^ R ) ) <-> ( ( P ^ Q ) ^ ( P ^ R ) )",
			ArrowProof(And(P, And(Q, R)),
				...
				IAnd(P, Q),
				IAnd(P, R),
				IAnd(And(P, Q), And(P, R)),
			),
			ArrowProof(And(And(P, Q), And(P, R)),
				EAnd(And(P, Q), And(P, R), true),
				EAnd(And(P, Q), And(P, R), false),
				EAnd(P, Q, true),
				EAnd(P, Q, false),
				EAnd(P, R, false),
				IAnd(Q, R),
