...
8. [distributivity](#distributivity)
    ...
    6. [( P v ( Q -> R ) ) <-> ( ( P v Q ) -> ( P v R ) )](#proof-8-6)
    7. [( P v ( Q v R ) ) <-> ( ( P v Q ) v ( P v R ) )](#proof-8-7)
    8. [( P v ( Q ^ R ) ) <-> ( ( P v Q ) ^ ( P v R ) )](#proof-8-8)
...
| 5 |  | <pre>.   ~ P</pre> | subproof ~ | 2 - 4 |
| 6 |  | <pre>.   P v ~ P</pre> | I v (R) | 5 |
| 7 |  | <pre>P v ~ P</pre> | subproof ~ | 1 - 6 |
...
| 7 |  | <pre>.   .   ~ P</pre> | subproof ~ | 3 - 6 |
| 8 |  | <pre>.   ~ Q -> ~ P</pre> | subproof -> | 2 - 7 |
| 9 |  | <pre>( P -> Q ) -> ( ~ Q -> ~ P )</pre> | subproof -> | 1 - 8 |
| 10 |  | <pre>.   ~ Q -> ~ P</pre> | Assume: -> |  |
| 11 |  | <pre>.   .   P</pre> | Assume: -> |  |
| 12 |  | <pre>.   .   .   ~ Q</pre> | Assume: ~ |  |
| 13 |  | <pre>.   .   .   ~ Q -> ~ P</pre> | Reiterate | 10 |
| 14 |  | <pre>.   .   .   ~ P</pre> | E -> | 13, 12 |
| 15 |  | <pre>.   .   .   P</pre> | Reiterate | 11 |
| 16 |  | <pre>.   .   Q</pre> | subproof ~ | 12 - 15 |
| 17 |  | <pre>.   P -> Q</pre> | subproof -> | 11 - 16 |
| 18 |  | <pre>( ~ Q -> ~ P ) -> ( P -> Q )</pre> | subproof -> | 10 - 17 |
...
| 5 |  | <pre>.   .   ~ Q -> ~ P</pre> | subproof -> | 3 - 4 |
| 6 |  | <pre>.   .   P -> Q</pre> | Theorem: contrapositive | 5 |
| 7 |  | <pre>.   .   ~ ( P -> Q )</pre> | Reiterate | 1 |
| 8 |  | <pre>.   P</pre> | subproof ~ | 2 - 7 |
| 9 |  | <pre>.   .   Q</pre> | Assume: ~ |  |
| 10 |  | <pre>.   .   P</pre> | Reiterate | 8 |
| 11 |  | <pre>.   .   P -> Q</pre> | I -> | 10, 9 |
| 12 |  | <pre>.   .   ~ ( P -> Q )</pre> | Reiterate | 1 |
| 13 |  | <pre>.   ~ Q</pre> | subproof ~ | 9 - 12 |
| 14 |  | <pre>.   P ^ ~ Q</pre> | I ^ | 8, 13 |
| 15 |  | <pre>~ ( P -> Q ) -> ( P ^ ~ Q )</pre> | subproof -> | 1 - 14 |
| 16 |  | <pre>.   P ^ ~ Q</pre> | Assume: -> |  |
| 17 |  | <pre>.   .   P -> Q</pre> | Assume: ~ |  |
| 18 |  | <pre>.   .   P ^ ~ Q</pre> | Reiterate | 16 |
| 19 |  | <pre>.   .   P</pre> | E ^ (L) | 18 |
| 20 |  | <pre>.   .   ~ Q</pre> | E ^ (R) | 18 |
| 21 |  | <pre>.   .   Q</pre> | E -> | 17, 19 |
| 22 |  | <pre>.   ~ ( P -> Q )</pre> | subproof ~ | 17 - 21 |
| 23 |  | <pre>( P ^ ~ Q ) -> ~ ( P -> Q )</pre> | subproof -> | 16 - 22 |
...
| 5 |  | <pre>.   .   ~ P -> Q</pre> | subproof -> | 3 - 4 |
| 6 |  | <pre>.   Q -> ( ~ P -> Q )</pre> | subproof -> | 2 - 5 |
| 7 |  | <pre>.   .   P</pre> | Assume: -> |  |
| 8 |  | <pre>.   .   .   ~ Q</pre> | Assume: -> |  |
| 9 |  | <pre>.   .   .   P</pre> | Reiterate | 7 |
| 10 |  | <pre>.   .   ~ Q -> P</pre> | subproof -> | 8 - 9 |
| 11 |  | <pre>.   .   ~ P -> Q</pre> | Theorem: contrapositive | 10 |
| 12 |  | <pre>.   P -> ( ~ P -> Q )</pre> | subproof -> | 7 - 11 |
| 13 |  | <pre>.   ~ P -> Q</pre> | E v | 12, 6, 1 |
| 14 |  | <pre>( P v Q ) -> ( ~ P -> Q )</pre> | subproof -> | 1 - 13 |
| 15 |  | <pre>.   ~ P -> Q</pre> | Assume: -> |  |
| 16 |  | <pre>.   .   P</pre> | Assume: -> |  |
| 17 |  | <pre>.   .   P v Q</pre> | I v (L) | 16 |
| 18 |  | <pre>.   P -> ( P v Q )</pre> | subproof -> | 16 - 17 |
| 19 |  | <pre>.   .   ~ P</pre> | Assume: -> |  |
| 20 |  | <pre>.   .   ~ P -> Q</pre> | Reiterate | 15 |
| 21 |  | <pre>.   .   Q</pre> | E -> | 20, 19 |
| 22 |  | <pre>.   .   P v Q</pre> | I v (R) | 21 |
| 23 |  | <pre>.   ~ P -> ( P v Q )</pre> | subproof -> | 19 - 22 |
| 24 |  | <pre>.   P v ~ P</pre> | Theorem: excluded middle |  |
| 25 |  | <pre>.   P v Q</pre> | E v | 18, 23, 24 |
| 26 |  | <pre>( ~ P -> Q ) -> ( P v Q )</pre> | subproof -> | 15 - 25 |
...
| 9 |  | <pre>.   ~ Q</pre> | subproof ~ | 6 - 8 |
| 10 |  | <pre>.   ~ P ^ ~ Q</pre> | I ^ | 5, 9 |
| 11 |  | <pre>~ ( P v Q ) -> ( ~ P ^ ~ Q )</pre> | subproof -> | 1 - 10 |
| 12 |  | <pre>.   ~ P ^ ~ Q</pre> | Assume: -> |  |
| 13 |  | <pre>.   .   P</pre> | Assume: -> |  |
| 14 |  | <pre>.   .   .   ~ P ^ ~ Q</pre> | Assume: ~ |  |
| 15 |  | <pre>.   .   .   ~ P</pre> | E ^ (L) | 14 |
| 16 |  | <pre>.   .   .   P</pre> | Reiterate | 13 |
| 17 |  | <pre>.   .   ~ ( ~ P ^ ~ Q )</pre> | subproof ~ | 14 - 16 |
| 18 |  | <pre>.   P -> ~ ( ~ P ^ ~ Q )</pre> | subproof -> | 13 - 17 |
| 19 |  | <pre>.   .   Q</pre> | Assume: -> |  |
| 20 |  | <pre>.   .   .   ~ P ^ ~ Q</pre> | Assume: ~ |  |
| 21 |  | <pre>.   .   .   ~ Q</pre> | E ^ (R) | 20 |
| 22 |  | <pre>.   .   .   Q</pre> | Reiterate | 19 |
| 23 |  | <pre>.   .   ~ ( ~ P ^ ~ Q )</pre> | subproof ~ | 20 - 22 |
| 24 |  | <pre>.   Q -> ~ ( ~ P ^ ~ Q )</pre> | subproof -> | 19 - 23 |
| 25 |  | <pre>.   .   P v Q</pre> | Assume: ~ |  |
| 26 |  | <pre>.   .   P -> ~ ( ~ P ^ ~ Q )</pre> | Reiterate | 18 |
| 27 |  | <pre>.   .   Q -> ~ ( ~ P ^ ~ Q )</pre> | Reiterate | 24 |
| 28 |  | <pre>.   .   ~ ( ~ P ^ ~ Q )</pre> | E v | 26, 27, 25 |
| 29 |  | <pre>.   .   ~ P ^ ~ Q</pre> | Reiterate | 12 |
| 30 |  | <pre>.   ~ ( P v Q )</pre> | subproof ~ | 25 - 29 |
| 31 |  | <pre>( ~ P ^ ~ Q ) -> ~ ( P v Q )</pre> | subproof -> | 12 - 30 |
...
| 6 |  | <pre>.   .   P</pre> | subproof ~ | 3 - 5 |
| 7 |  | <pre>.   .   .   ~ Q</pre> | Assume: ~ |  |
| 8 |  | <pre>.   .   .   ~ P v ~ Q</pre> | I v (R) | 7 |
| 9 |  | <pre>.   .   .   ~ ( ~ P v ~ Q )</pre> | Reiterate | 2 |
| 10 |  | <pre>.   .   Q</pre> | subproof ~ | 7 - 9 |
| 11 |  | <pre>.   .   P ^ Q</pre> | I ^ | 6, 10 |
| 12 |  | <pre>.   .   ~ ( P ^ Q )</pre> | Reiterate | 1 |
| 13 |  | <pre>.   ~ P v ~ Q</pre> | subproof ~ | 2 - 12 |
| 14 |  | <pre>~ ( P ^ Q ) -> ( ~ P v ~ Q )</pre> | subproof -> | 1 - 13 |
| 15 |  | <pre>.   ~ P v ~ Q</pre> | Assume: -> |  |
| 16 |  | <pre>.   .   ~ P</pre> | Assume: -> |  |
| 17 |  | <pre>.   .   .   P ^ Q</pre> | Assume: ~ |  |
| 18 |  | <pre>.   .   .   P</pre> | E ^ (L) | 17 |
| 19 |  | <pre>.   .   .   ~ P</pre> | Reiterate | 16 |
| 20 |  | <pre>.   .   ~ ( P ^ Q )</pre> | subproof ~ | 17 - 19 |
| 21 |  | <pre>.   ~ P -> ~ ( P ^ Q )</pre> | subproof -> | 16 - 20 |
| 22 |  | <pre>.   .   ~ Q</pre> | Assume: -> |  |
| 23 |  | <pre>.   .   .   P ^ Q</pre> | Assume: ~ |  |
| 24 |  | <pre>.   .   .   Q</pre> | E ^ (R) | 23 |
| 25 |  | <pre>.   .   .   ~ Q</pre> | Reiterate | 22 |
| 26 |  | <pre>.   .   ~ ( P ^ Q )</pre> | subproof ~ | 23 - 25 |
| 27 |  | <pre>.   ~ Q -> ~ ( P ^ Q )</pre> | subproof -> | 22 - 26 |
| 28 |  | <pre>.   ~ ( P ^ Q )</pre> | E v | 21, 27, 15 |
| 29 |  | <pre>( ~ P v ~ Q ) -> ~ ( P ^ Q )</pre> | subproof -> | 15 - 28 |
...
| 9 |  | <pre>.   .   .   Q</pre> | E -> | 7, 8 |
| 10 |  | <pre>.   .   .   ~ Q</pre> | E -> | 6, 8 |
| 11 |  | <pre>.   .   ~ ( P <-> Q )</pre> | subproof ~ | 5 - 10 |
| 12 |  | <pre>.   P -> ~ ( P <-> Q )</pre> | subproof -> | 4 - 11 |
| 13 |  | <pre>.   .   ~ P</pre> | Assume: -> |  |
| 14 |  | <pre>.   .   .   P <-> Q</pre> | Assume: ~ |  |
...
| 21 |  | <pre>.   .   ~ ( P <-> Q )</pre> | subproof ~ | 14 - 20 |
| 22 |  | <pre>.   ~ P -> ~ ( P <-> Q )</pre> | subproof -> | 13 - 21 |
| 23 |  | <pre>.   P v ~ P</pre> | Theorem: excluded middle |  |
| 24 |  | <pre>.   ~ ( P <-> Q )</pre> | E v | 12, 22, 23 |
| 25 |  | <pre>( P <-> ~ Q ) -> ~ ( P <-> Q )</pre> | subproof -> | 1 - 24 |
| 26 |  | <pre>.   ~ ( P <-> Q )</pre> | Assume: -> |  |
| 27 |  | <pre>.   .   ~ ( P -> ~ Q )</pre> | Assume: ~ |  |
...
| 35 |  | <pre>.   P -> ~ Q</pre> | subproof ~ | 27 - 34 |
| 36 |  | <pre>.   .   ~ ( ~ Q -> P )</pre> | Assume: ~ |  |
...
| 46 |  | <pre>.   ~ Q -> P</pre> | subproof ~ | 36 - 45 |
| 47 |  | <pre>.   P <-> ~ Q</pre> | I <-> | 35, 46 |
| 48 |  | <pre>~ ( P <-> Q ) -> ( P <-> ~ Q )</pre> | subproof -> | 26 - 47 |
...
| 2 |  | <pre>.   P</pre> | E ^ (L) | 1 |
| 3 |  | <pre>( P ^ P ) -> P</pre> | subproof -> | 1 - 2 |
| 4 |  | <pre>.   P</pre> | Assume: -> |  |
| 5 |  | <pre>.   P ^ P</pre> | I ^ | 4, 4 |
| 6 |  | <pre>P -> ( P ^ P )</pre> | subproof -> | 4 - 5 |
...
| 1 |  | <pre>.   P v P</pre> | Assume: -> |  |
| 2 |  | <pre>.   .   P</pre> | Assume: -> |  |
| 3 |  | <pre>.   P -> P</pre> | subproof -> | 2 - 2 |
| 4 |  | <pre>.   P</pre> | E v | 3, 3, 1 |
| 5 |  | <pre>( P v P ) -> P</pre> | subproof -> | 1 - 4 |
| 6 |  | <pre>.   P</pre> | Assume: -> |  |
| 7 |  | <pre>.   P v P</pre> | I v (L) | 6 |
| 8 |  | <pre>P -> ( P v P )</pre> | subproof -> | 6 - 7 |
...
| 2 |  | <pre>.   P</pre> | E ^ (L) | 1 |
| 3 |  | <pre>.   P v Q</pre> | I v (L) | 2 |
| 4 |  | <pre>( P ^ Q ) -> ( P v Q )</pre> | subproof -> | 1 - 3 |
...
| 4 |  | <pre>.   P -> Q</pre> | subproof -> | 2 - 3 |
| 5 |  | <pre>Q -> ( P -> Q )</pre> | subproof -> | 1 - 4 |
...
| 4 |  | <pre>.   ~ Q -> ~ P</pre> | subproof -> | 2 - 3 |
| 5 |  | <pre>.   P -> Q</pre> | Theorem: contrapositive | 4 |
| 6 |  | <pre>~ P -> ( P -> Q )</pre> | subproof -> | 1 - 5 |
...
| 7 |  | <pre>.   .   .   R</pre> | E -> | 6, 5 |
| 8 |  | <pre>.   .   Q -> R</pre> | subproof -> | 3 - 7 |
| 9 |  | <pre>.   P -> ( Q -> R )</pre> | subproof -> | 2 - 8 |
| 10 |  | <pre>( ( P ^ Q ) -> R ) -> ( P -> ( Q -> R ) )</pre> | subproof -> | 1 - 9 |
| 11 |  | <pre>.   P -> ( Q -> R )</pre> | Assume: -> |  |
| 12 |  | <pre>.   .   P ^ Q</pre> | Assume: -> |  |
| 13 |  | <pre>.   .   P</pre> | E ^ (L) | 12 |
| 14 |  | <pre>.   .   Q</pre> | E ^ (R) | 12 |
...
| 18 |  | <pre>.   ( P ^ Q ) -> R</pre> | subproof -> | 12 - 17 |
| 19 |  | <pre>( P -> ( Q -> R ) ) -> ( ( P ^ Q ) -> R )</pre> | subproof -> | 11 - 18 |
...
| 7 |  | <pre>.   .   ~ Q</pre> | E -> | 5, 2 |
| 8 |  | <pre>.   ~ P</pre> | subproof ~ | 2 - 7 |
| 9 |  | <pre>( ( P -> Q ) ^ ( P -> ~ Q ) ) -> ~ P</pre> | subproof -> | 1 - 8 |
...
| 6 |  | <pre>( ( P -> Q ) ^ ( ~ P -> Q ) ) -> Q</pre> | subproof -> | 1 - 5 |
...
| 6 |  | <pre>.   .   .   Q</pre> | Reiterate | 2 |
| 7 |  | <pre>.   .   .   R</pre> | E -> | 5, 6 |
| 8 |  | <pre>.   .   P -> R</pre> | subproof -> | 3 - 7 |
| 9 |  | <pre>.   Q -> ( P -> R )</pre> | subproof -> | 2 - 8 |
| 10 |  | <pre>( P -> ( Q -> R ) ) -> ( Q -> ( P -> R ) )</pre> | subproof -> | 1 - 9 |
...
| 7 |  | <pre>.   .   .   R</pre> | E -> | 5, 6 |
| 8 |  | <pre>.   .   P -> R</pre> | subproof -> | 3 - 7 |
| 9 |  | <pre>.   ( Q -> R ) -> ( P -> R )</pre> | subproof -> | 2 - 8 |
| 10 |  | <pre>( P -> Q ) -> ( ( Q -> R ) -> ( P -> R ) )</pre> | subproof -> | 1 - 9 |
...
| 13 |  | <pre>.   .   P -> R</pre> | subproof -> | 8 - 12 |
| 14 |  | <pre>.   .   .   R</pre> | Assume: -> |  |
| 15 |  | <pre>.   .   .   R -> Q</pre> | Reiterate | 7 |
| 16 |  | <pre>.   .   .   Q -> P</pre> | Reiterate | 5 |
| 17 |  | <pre>.   .   .   Q</pre> | E -> | 15, 14 |
| 18 |  | <pre>.   .   .   P</pre> | E -> | 16, 17 |
| 19 |  | <pre>.   .   R -> P</pre> | subproof -> | 14 - 18 |
| 20 |  | <pre>.   .   P <-> R</pre> | I <-> | 13, 19 |
| 21 |  | <pre>.   ( Q <-> R ) -> ( P <-> R )</pre> | subproof -> | 2 - 20 |
| 22 |  | <pre>( P <-> Q ) -> ( ( Q <-> R ) -> ( P <-> R ) )</pre> | subproof -> | 1 - 21 |
...
| 3 |  | <pre>.   Q</pre> | E ^ (R) | 1 |
| 4 |  | <pre>.   Q ^ P</pre> | I ^ | 3, 2 |
| 5 |  | <pre>( P ^ Q ) -> ( Q ^ P )</pre> | subproof -> | 1 - 4 |
...
| 4 |  | <pre>.   P -> ( Q v P )</pre> | subproof -> | 2 - 3 |
| 5 |  | <pre>.   .   Q</pre> | Assume: -> |  |
| 6 |  | <pre>.   .   Q v P</pre> | I v (L) | 5 |
| 7 |  | <pre>.   Q -> ( Q v P )</pre> | subproof -> | 5 - 6 |
| 8 |  | <pre>.   Q v P</pre> | E v | 4, 7, 1 |
| 9 |  | <pre>( P v Q ) -> ( Q v P )</pre> | subproof -> | 1 - 8 |
...
| 8 |  | <pre>( ( P ^ Q ) ^ R ) -> ( P ^ ( Q ^ R ) )</pre> | subproof -> | 1 - 7 |
| 9 |  | <pre>.   P ^ ( Q ^ R )</pre> | Assume: -> |  |
| 10 |  | <pre>.   P</pre> | E ^ (L) | 9 |
...
| 16 |  | <pre>( P ^ ( Q ^ R ) ) -> ( ( P ^ Q ) ^ R )</pre> | subproof -> | 9 - 15 |
...
| 5 |  | <pre>.   .   P -> ( P v ( Q v R ) )</pre> | subproof -> | 3 - 4 |
| 6 |  | <pre>.   .   .   Q</pre> | Assume: -> |  |
| 7 |  | <pre>.   .   .   Q v R</pre> | I v (L) | 6 |
| 8 |  | <pre>.   .   .   P v ( Q v R )</pre> | I v (R) | 7 |
| 9 |  | <pre>.   .   Q -> ( P v ( Q v R ) )</pre> | subproof -> | 6 - 8 |
| 10 |  | <pre>.   .   P v ( Q v R )</pre> | E v | 5, 9, 2 |
| 11 |  | <pre>.   ( P v Q ) -> ( P v ( Q v R ) )</pre> | subproof -> | 2 - 10 |
| 12 |  | <pre>.   .   R</pre> | Assume: -> |  |
| 13 |  | <pre>.   .   Q v R</pre> | I v (R) | 12 |
| 14 |  | <pre>.   .   P v ( Q v R )</pre> | I v (R) | 13 |
| 15 |  | <pre>.   R -> ( P v ( Q v R ) )</pre> | subproof -> | 12 - 14 |
| 16 |  | <pre>.   P v ( Q v R )</pre> | E v | 11, 15, 1 |
| 17 |  | <pre>( ( P v Q ) v R ) -> ( P v ( Q v R ) )</pre> | subproof -> | 1 - 16 |
| 18 |  | <pre>.   P v ( Q v R )</pre> | Assume: -> |  |
| 19 |  | <pre>.   .   P</pre> | Assume: -> |  |
| 20 |  | <pre>.   .   P v Q</pre> | I v (L) | 19 |
| 21 |  | <pre>.   .   ( P v Q ) v R</pre> | I v (L) | 20 |
| 22 |  | <pre>.   P -> ( ( P v Q ) v R )</pre> | subproof -> | 19 - 21 |
| 23 |  | <pre>.   .   Q v R</pre> | Assume: -> |  |
| 24 |  | <pre>.   .   .   Q</pre> | Assume: -> |  |
| 25 |  | <pre>.   .   .   P v Q</pre> | I v (R) | 24 |
| 26 |  | <pre>.   .   .   ( P v Q ) v R</pre> | I v (L) | 25 |
| 27 |  | <pre>.   .   Q -> ( ( P v Q ) v R )</pre> | subproof -> | 24 - 26 |
| 28 |  | <pre>.   .   .   R</pre> | Assume: -> |  |
| 29 |  | <pre>.   .   .   ( P v Q ) v R</pre> | I v (R) | 28 |
| 30 |  | <pre>.   .   R -> ( ( P v Q ) v R )</pre> | subproof -> | 28 - 29 |
| 31 |  | <pre>.   .   ( P v Q ) v R</pre> | E v | 27, 30, 23 |
| 32 |  | <pre>.   ( Q v R ) -> ( ( P v Q ) v R )</pre> | subproof -> | 23 - 31 |
| 33 |  | <pre>.   ( P v Q ) v R</pre> | E v | 22, 32, 18 |
| 34 |  | <pre>( P v ( Q v R ) ) -> ( ( P v Q ) v R )</pre> | subproof -> | 18 - 33 |
...
| 26 |  | <pre>.   .   ~ Q</pre> | E -> | 25, 6 |
| 27 |  | <pre>.   P -> ( Q <-> R )</pre> | subproof ~ | 4 - 26 |
| 28 |  | <pre>.   .   ~ ( ( Q <-> R ) -> P )</pre> | Assume: ~ |  |
...
| 51 |  | <pre>.   ( Q <-> R ) -> P</pre> | subproof ~ | 28 - 50 |
| 52 |  | <pre>.   P <-> ( Q <-> R )</pre> | I <-> | 27, 51 |
| 53 |  | <pre>( ( P <-> Q ) <-> R ) -> ( P <-> ( Q <-> R ) )</pre> | subproof -> | 1 - 52 |
| 54 |  | <pre>.   P <-> ( Q <-> R )</pre> | Assume: -> |  |
| 55 |  | <pre>.   P -> ( Q <-> R )</pre> | E <-> (L) | 54 |
| 56 |  | <pre>.   ( Q <-> R ) -> P</pre> | E <-> (R) | 54 |
| 57 |  | <pre>.   .   ~ ( ( P <-> Q ) -> R )</pre> | Assume: ~ |  |
...
| 79 |  | <pre>.   ( P <-> Q ) -> R</pre> | subproof ~ | 57 - 78 |
| 80 |  | <pre>.   .   ~ ( R -> ( P <-> Q ) )</pre> | Assume: ~ |  |
...
| 104 |  | <pre>.   R -> ( P <-> Q )</pre> | subproof ~ | 80 - 103 |
| 105 |  | <pre>.   ( P <-> Q ) <-> R</pre> | I <-> | 79, 104 |
| 106 |  | <pre>( P <-> ( Q <-> R ) ) -> ( ( P <-> Q ) <-> R )</pre> | subproof -> | 54 - 105 |
...
| 7 |  | <pre>.   .   .   Q</pre> | E -> | 6, 3 |
| 8 |  | <pre>.   .   .   R</pre> | E -> | 5, 7 |
| 9 |  | <pre>.   .   P -> R</pre> | subproof -> | 3 - 8 |
| 10 |  | <pre>.   ( P -> Q ) -> ( P -> R )</pre> | subproof -> | 2 - 9 |
| 11 |  | <pre>( P -> ( Q -> R ) ) -> ( ( P -> Q ) -> ( P -> R ) )</pre> | subproof -> | 1 - 10 |
| 12 |  | <pre>.   ( P -> Q ) -> ( P -> R )</pre> | Assume: -> |  |
| 13 |  | <pre>.   .   P</pre> | Assume: -> |  |
| 14 |  | <pre>.   .   .   Q</pre> | Assume: -> |  |
...
| 20 |  | <pre>.   .   Q -> R</pre> | subproof -> | 14 - 19 |
| 21 |  | <pre>.   P -> ( Q -> R )</pre> | subproof -> | 13 - 20 |
| 22 |  | <pre>( ( P -> Q ) -> ( P -> R ) ) -> ( P -> ( Q -> R ) )</pre> | subproof -> | 12 - 21 |
...
| 4 |  | <pre>.   .   Q ^ R</pre> | E -> | 3, 2 |
| 5 |  | <pre>.   .   Q</pre> | E ^ (L) | 4 |
| 6 |  | <pre>.   P -> Q</pre> | subproof -> | 2 - 5 |
| 7 |  | <pre>.   .   P</pre> | Assume: -> |  |
| 8 |  | <pre>.   .   P -> ( Q ^ R )</pre> | Reiterate | 1 |
| 9 |  | <pre>.   .   Q ^ R</pre> | E -> | 8, 7 |
| 10 |  | <pre>.   .   R</pre> | E ^ (R) | 9 |
| 11 |  | <pre>.   P -> R</pre> | subproof -> | 7 - 10 |
| 12 |  | <pre>.   ( P -> Q ) ^ ( P -> R )</pre> | I ^ | 6, 11 |
| 13 |  | <pre>( P -> ( Q ^ R ) ) -> ( ( P -> Q ) ^ ( P -> R ) )</pre> | subproof -> | 1 - 12 |
| 14 |  | <pre>.   ( P -> Q ) ^ ( P -> R )</pre> | Assume: -> |  |
| 15 |  | <pre>.   .   P</pre> | Assume: -> |  |
...
| 22 |  | <pre>.   P -> ( Q ^ R )</pre> | subproof -> | 15 - 21 |
| 23 |  | <pre>( ( P -> Q ) ^ ( P -> R ) ) -> ( P -> ( Q ^ R ) )</pre> | subproof -> | 14 - 22 |
...
| 7 |  | <pre>.   .   R</pre> | E -> | 6, 5 |
| 8 |  | <pre>.   .   P ^ R</pre> | I ^ | 4, 7 |
| 9 |  | <pre>.   ( P ^ Q ) -> ( P ^ R )</pre> | subproof -> | 2 - 8 |
| 10 |  | <pre>( P ^ ( Q -> R ) ) -> ( ( P ^ Q ) -> ( P ^ R ) )</pre> | subproof -> | 1 - 9 |
...
| 8 |  | <pre>.   Q -> ( ( P ^ Q ) v ( P ^ R ) )</pre> | subproof -> | 4 - 7 |
| 9 |  | <pre>.   .   R</pre> | Assume: -> |  |
| 10 |  | <pre>.   .   P</pre> | Reiterate | 2 |
| 11 |  | <pre>.   .   P ^ R</pre> | I ^ | 10, 9 |
| 12 |  | <pre>.   .   ( P ^ Q ) v ( P ^ R )</pre> | I v (R) | 11 |
| 13 |  | <pre>.   R -> ( ( P ^ Q ) v ( P ^ R ) )</pre> | subproof -> | 9 - 12 |
| 14 |  | <pre>.   ( P ^ Q ) v ( P ^ R )</pre> | E v | 8, 13, 3 |
| 15 |  | <pre>( P ^ ( Q v R ) ) -> ( ( P ^ Q ) v ( P ^ R ) )</pre> | subproof -> | 1 - 14 |
| 16 |  | <pre>.   ( P ^ Q ) v ( P ^ R )</pre> | Assume: -> |  |
| 17 |  | <pre>.   .   P ^ Q</pre> | Assume: -> |  |
| 18 |  | <pre>.   .   P</pre> | E ^ (L) | 17 |
| 19 |  | <pre>.   .   Q</pre> | E ^ (R) | 17 |
| 20 |  | <pre>.   .   Q v R</pre> | I v (L) | 19 |
| 21 |  | <pre>.   .   P ^ ( Q v R )</pre> | I ^ | 18, 20 |
| 22 |  | <pre>.   ( P ^ Q ) -> ( P ^ ( Q v R ) )</pre> | subproof -> | 17 - 21 |
| 23 |  | <pre>.   .   P ^ R</pre> | Assume: -> |  |
| 24 |  | <pre>.   .   P</pre> | E ^ (L) | 23 |
| 25 |  | <pre>.   .   R</pre> | E ^ (R) | 23 |
| 26 |  | <pre>.   .   Q v R</pre> | I v (R) | 25 |
| 27 |  | <pre>.   .   P ^ ( Q v R )</pre> | I ^ | 24, 26 |
| 28 |  | <pre>.   ( P ^ R ) -> ( P ^ ( Q v R ) )</pre> | subproof -> | 23 - 27 |
| 29 |  | <pre>.   P ^ ( Q v R )</pre> | E v | 22, 28, 16 |
| 30 |  | <pre>( ( P ^ Q ) v ( P ^ R ) ) -> ( P ^ ( Q v R ) )</pre> | subproof -> | 16 - 29 |
| 31 |  | <pre>( P ^ ( Q v R ) ) <-> ( ( P ^ Q ) v ( P ^ R ) )</pre> | I <-> | 15, 30 |

## ( P v ( Q -> R ) ) <-> ( ( P v Q ) -> ( P v R ) ) <a name="proof-8-6"></a>
...
| 5 |  | <pre>.   .   P -> ( P v R )</pre> | subproof -> | 3 - 4 |
| 6 |  | <pre>.   .   .   ~ P</pre> | Assume: -> |  |
...
| 15 |  | <pre>.   .   ~ P -> ( P v R )</pre> | subproof -> | 6 - 14 |
| 16 |  | <pre>.   .   P v ~ P</pre> | Theorem: excluded middle |  |
| 17 |  | <pre>.   .   P v R</pre> | E v | 5, 15, 16 |
| 18 |  | <pre>.   ( P v Q ) -> ( P v R )</pre> | subproof -> | 2 - 17 |
| 19 |  | <pre>( P v ( Q -> R ) ) -> ( ( P v Q ) -> ( P v R ) )</pre> | subproof -> | 1 - 18 |
| 20 |  | <pre>.   ( P v Q ) -> ( P v R )</pre> | Assume: -> |  |
| 21 |  | <pre>.   .   P</pre> | Assume: -> |  |
| 22 |  | <pre>.   .   P v ( Q -> R )</pre> | I v (L) | 21 |
| 23 |  | <pre>.   P -> ( P v ( Q -> R ) )</pre> | subproof -> | 21 - 22 |
| 24 |  | <pre>.   .   ~ P</pre> | Assume: -> |  |
| 25 |  | <pre>.   .   .   Q</pre> | Assume: -> |  |
...
| 5 |  | <pre>.   P -> ( ( P v Q ) v ( P v R ) )</pre> | subproof -> | 2 - 4 |
| 6 |  | <pre>.   .   Q v R</pre> | Assume: -> |  |
| 7 |  | <pre>.   .   .   Q</pre> | Assume: -> |  |
| 8 |  | <pre>.   .   .   P v Q</pre> | I v (R) | 7 |
| 9 |  | <pre>.   .   .   ( P v Q ) v ( P v R )</pre> | I v (L) | 8 |
| 10 |  | <pre>.   .   Q -> ( ( P v Q ) v ( P v R ) )</pre> | subproof -> | 7 - 9 |
| 11 |  | <pre>.   .   .   R</pre> | Assume: -> |  |
| 12 |  | <pre>.   .   .   P v R</pre> | I v (R) | 11 |
| 13 |  | <pre>.   .   .   ( P v Q ) v ( P v R )</pre> | I v (R) | 12 |
| 14 |  | <pre>.   .   R -> ( ( P v Q ) v ( P v R ) )</pre> | subproof -> | 11 - 13 |
| 15 |  | <pre>.   .   ( P v Q ) v ( P v R )</pre> | E v | 10, 14, 6 |
| 16 |  | <pre>.   ( Q v R ) -> ( ( P v Q ) v ( P v R ) )</pre> | subproof -> | 6 - 15 |
| 17 |  | <pre>.   ( P v Q ) v ( P v R )</pre> | E v | 5, 16, 1 |
| 18 |  | <pre>( P v ( Q v R ) ) -> ( ( P v Q ) v ( P v R ) )</pre> | subproof -> | 1 - 17 |
| 19 |  | <pre>.   ( P v Q ) v ( P v R )</pre> | Assume: -> |  |
| 20 |  | <pre>.   .   P v Q</pre> | Assume: -> |  |
| 21 |  | <pre>.   .   .   P</pre> | Assume: -> |  |
| 22 |  | <pre>.   .   .   P v ( Q v R )</pre> | I v (L) | 21 |
| 23 |  | <pre>.   .   P -> ( P v ( Q v R ) )</pre> | subproof -> | 21 - 22 |
| 24 |  | <pre>.   .   .   Q</pre> | Assume: -> |  |
| 25 |  | <pre>.   .   .   Q v R</pre> | I v (L) | 24 |
| 26 |  | <pre>.   .   .   P v ( Q v R )</pre> | I v (R) | 25 |
| 27 |  | <pre>.   .   Q -> ( P v ( Q v R ) )</pre> | subproof -> | 24 - 26 |
| 28 |  | <pre>.   .   P v ( Q v R )</pre> | E v | 23, 27, 20 |
| 29 |  | <pre>.   ( P v Q ) -> ( P v ( Q v R ) )</pre> | subproof -> | 20 - 28 |
| 30 |  | <pre>.   .   P v R</pre> | Assume: -> |  |
| 31 |  | <pre>.   .   .   P</pre> | Assume: -> |  |
| 32 |  | <pre>.   .   .   P v ( Q v R )</pre> | I v (L) | 31 |
| 33 |  | <pre>.   .   P -> ( P v ( Q v R ) )</pre> | subproof -> | 31 - 32 |
| 34 |  | <pre>.   .   .   R</pre> | Assume: -> |  |
| 35 |  | <pre>.   .   .   Q v R</pre> | I v (R) | 34 |
| 36 |  | <pre>.   .   .   P v ( Q v R )</pre> | I v (R) | 35 |
| 37 |  | <pre>.   .   R -> ( P v ( Q v R ) )</pre> | subproof -> | 34 - 36 |
| 38 |  | <pre>.   .   P v ( Q v R )</pre> | E v | 33, 37, 30 |
| 39 |  | <pre>.   ( P v R ) -> ( P v ( Q v R ) )</pre> | subproof -> | 30 - 38 |
| 40 |  | <pre>.   P v ( Q v R )</pre> | E v | 29, 39, 19 |
| 41 |  | <pre>( ( P v Q ) v ( P v R ) ) -> ( P v ( Q v R ) )</pre> | subproof -> | 19 - 40 |
| 42 |  | <pre>( P v ( Q v R ) ) <-> ( ( P v Q ) v ( P v R ) )</pre> | I <-> | 18, 41 |

## ( P v ( Q ^ R ) ) <-> ( ( P v Q ) ^ ( P v R ) ) <a name="proof-8-8"></a>
...
| 6 |  | <pre>.   P -> ( ( P v Q ) ^ ( P v R ) )</pre> | subproof -> | 2 - 5 |
...
| 13 |  | <pre>.   ( Q ^ R ) -> ( ( P v Q ) ^ ( P v R ) )</pre> | subproof -> | 7 - 12 |
| 14 |  | <pre>.   ( P v Q ) ^ ( P v R )</pre> | E v | 6, 13, 1 |
| 15 |  | <pre>( P v ( Q ^ R ) ) -> ( ( P v Q ) ^ ( P v R ) )</pre> | subproof -> | 1 - 14 |
| 16 |  | <pre>.   ( P v Q ) ^ ( P v R )</pre> | Assume: -> |  |
| 17 |  | <pre>.   P v Q</pre> | E ^ (L) | 16 |
| 18 |  | <pre>.   P v R</pre> | E ^ (R) | 16 |
| 19 |  | <pre>.   .   P</pre> | Assume: -> |  |
| 20 |  | <pre>.   .   P v ( Q ^ R )</pre> | I v (L) | 19 |
| 21 |  | <pre>.   P -> ( P v ( Q ^ R ) )</pre> | subproof -> | 19 - 20 |
| 22 |  | <pre>.   .   P</pre> | Assume: -> |  |
| 23 |  | <pre>.   .   .   ~ Q</pre> | Assume: -> |  |
| 24 |  | <pre>.   .   .   P</pre> | Reiterate | 22 |
| 25 |  | <pre>.   .   ~ Q -> P</pre> | subproof -> | 23 - 24 |
| 26 |  | <pre>.   .   ~ P -> Q</pre> | Theorem: contrapositive | 25 |
| 27 |  | <pre>.   P -> ( ~ P -> Q )</pre> | subproof -> | 22 - 26 |
| 28 |  | <pre>.   .   P</pre> | Assume: -> |  |
| 29 |  | <pre>.   .   .   ~ R</pre> | Assume: -> |  |
| 30 |  | <pre>.   .   .   P</pre> | Reiterate | 28 |
| 31 |  | <pre>.   .   ~ R -> P</pre> | subproof -> | 29 - 30 |
| 32 |  | <pre>.   .   ~ P -> R</pre> | Theorem: contrapositive | 31 |
| 33 |  | <pre>.   P -> ( ~ P -> R )</pre> | subproof -> | 28 - 32 |
| 34 |  | <pre>.   .   ~ P</pre> | Assume: -> |  |
...
| 40 |  | <pre>.   .   Q -> ( ~ P -> Q )</pre> | subproof -> | 37 - 39 |
...
| 47 |  | <pre>.   .   R -> ( ~ P -> R )</pre> | subproof -> | 44 - 46 |
...
| 53 |  | <pre>.   ~ P -> ( P v ( Q ^ R ) )</pre> | subproof -> | 34 - 52 |
| 54 |  | <pre>.   P v ~ P</pre> | Theorem: excluded middle |  |
| 55 |  | <pre>.   P v ( Q ^ R )</pre> | E v | 21, 53, 54 |
| 56 |  | <pre>( ( P v Q ) ^ ( P v R ) ) -> ( P v ( Q ^ R ) )</pre> | subproof -> | 16 - 55 |
...
| 5 |  | <pre>.   .   R</pre> | E -> | 4, 3 |
| 6 |  | <pre>.   P -> R</pre> | subproof -> | 2 - 5 |
| 7 |  | <pre>.   .   Q</pre> | Assume: -> |  |
| 8 |  | <pre>.   .   P v Q</pre> | I v (R) | 7 |
| 9 |  | <pre>.   .   ( P v Q ) -> R</pre> | Reiterate | 1 |
| 10 |  | <pre>.   .   R</pre> | E -> | 9, 8 |
| 11 |  | <pre>.   Q -> R</pre> | subproof -> | 7 - 10 |
| 12 |  | <pre>.   ( P -> R ) ^ ( Q -> R )</pre> | I ^ | 6, 11 |
| 13 |  | <pre>( ( P v Q ) -> R ) -> ( ( P -> R ) ^ ( Q -> R ) )</pre> | subproof -> | 1 - 12 |
| 14 |  | <pre>.   ( P -> R ) ^ ( Q -> R )</pre> | Assume: -> |  |
| 15 |  | <pre>.   .   P v Q</pre> | Assume: -> |  |
| 16 |  | <pre>.   .   ( P -> R ) ^ ( Q -> R )</pre> | Reiterate | 14 |
| 17 |  | <pre>.   .   P -> R</pre> | E ^ (L) | 16 |
| 18 |  | <pre>.   .   Q -> R</pre> | E ^ (R) | 16 |
| 19 |  | <pre>.   .   R</pre> | E v | 17, 18, 15 |
| 20 |  | <pre>.   ( P v Q ) -> R</pre> | subproof -> | 15 - 19 |
...
| 5 |  | <pre>.   .   .   P</pre> | E ^ (L) | 3 |
| 6 |  | <pre>.   .   .   R</pre> | E -> | 4, 5 |
| 7 |  | <pre>.   .   ( P ^ Q ) -> R</pre> | subproof -> | 3 - 6 |
| 8 |  | <pre>.   ( P -> R ) -> ( ( P ^ Q ) -> R )</pre> | subproof -> | 2 - 7 |
| 9 |  | <pre>.   .   Q -> R</pre> | Assume: -> |  |
| 10 |  | <pre>.   .   .   P ^ Q</pre> | Assume: -> |  |
| 11 |  | <pre>.   .   .   Q -> R</pre> | Reiterate | 9 |
| 12 |  | <pre>.   .   .   Q</pre> | E ^ (R) | 10 |
| 13 |  | <pre>.   .   .   R</pre> | E -> | 11, 12 |
| 14 |  | <pre>.   .   ( P ^ Q ) -> R</pre> | subproof -> | 10 - 13 |
| 15 |  | <pre>.   ( Q -> R ) -> ( ( P ^ Q ) -> R )</pre> | subproof -> | 9 - 14 |
| 16 |  | <pre>.   ( P ^ Q ) -> R</pre> | E v | 8, 15, 1 |
| 17 |  | <pre>( ( P -> R ) v ( Q -> R ) ) -> ( ( P ^ Q ) -> R )</pre> | subproof -> | 1 - 16 |
| 18 |  | <pre>.   ( P ^ Q ) -> R</pre> | Assume: -> |  |
| 19 |  | <pre>.   .   ~ ( ( P -> R ) v ( Q -> R ) )</pre> | Assume: ~ |  |
...
| 26 |  | <pre>.   .   R -> ( ( ( P ^ R ) v ( P ^ S ) ) v ( ( Q ^ R ) v ( Q ^ S ) ) )</pre> | subproof -> | 21 - 25 |
| 27 |  | <pre>.   .   .   S</pre> | Assume: -> |  |
| 28 |  | <pre>.   .   .   Q</pre> | Reiterate | 20 |
| 29 |  | <pre>.   .   .   Q ^ S</pre> | I ^ | 28, 27 |
| 30 |  | <pre>.   .   .   ( Q ^ R ) v ( Q ^ S )</pre> | I v (R) | 29 |
| 31 |  | <pre>.   .   .   ( ( P ^ R ) v ( P ^ S ) ) v ( ( Q ^ R ) v ( Q ^ S ) )</pre> | I v (R) | 30 |
| 32 |  | <pre>.   .   S -> ( ( ( P ^ R ) v ( P ^ S ) ) v ( ( Q ^ R ) v ( Q ^ S ) ) )</pre> | subproof -> | 27 - 31 |
| 33 |  | <pre>.   .   R v S</pre> | Reiterate | 3 |
| 34 |  | <pre>.   .   ( ( P ^ R ) v ( P ^ S ) ) v ( ( Q ^ R ) v ( Q ^ S ) )</pre> | E v | 26, 32, 33 |
| 35 |  | <pre>.   Q -> ( ( ( P ^ R ) v ( P ^ S ) ) v ( ( Q ^ R ) v ( Q ^ S ) ) )</pre> | subproof -> | 20 - 34 |
| 36 |  | <pre>.   ( ( P ^ R ) v ( P ^ S ) ) v ( ( Q ^ R ) v ( Q ^ S ) )</pre> | E v | 19, 35, 2 |
| 37 |  | <pre>( ( P v Q ) ^ ( R v S ) ) -> ( ( ( P ^ R ) v ( P ^ S ) ) v ( ( Q ^ R ) v ( Q ^ S ) ) )</pre> | subproof -> | 1 - 36 |
| 38 |  | <pre>.   ( ( P ^ R ) v ( P ^ S ) ) v ( ( Q ^ R ) v ( Q ^ S ) )</pre> | Assume: -> |  |
| 39 |  | <pre>.   .   ( P ^ R ) v ( P ^ S )</pre> | Assume: -> |  |
| 40 |  | <pre>.   .   .   P ^ R</pre> | Assume: -> |  |
| 41 |  | <pre>.   .   .   P</pre> | E ^ (L) | 40 |
| 42 |  | <pre>.   .   .   R</pre> | E ^ (R) | 40 |
| 43 |  | <pre>.   .   .   P v Q</pre> | I v (L) | 41 |
| 44 |  | <pre>.   .   .   R v S</pre> | I v (L) | 42 |
| 45 |  | <pre>.   .   .   ( P v Q ) ^ ( R v S )</pre> | I ^ | 43, 44 |
| 46 |  | <pre>.   .   ( P ^ R ) -> ( ( P v Q ) ^ ( R v S ) )</pre> | subproof -> | 40 - 45 |
| 47 |  | <pre>.   .   .   P ^ S</pre> | Assume: -> |  |
| 48 |  | <pre>.   .   .   P</pre> | E ^ (L) | 47 |
| 49 |  | <pre>.   .   .   S</pre> | E ^ (R) | 47 |
| 50 |  | <pre>.   .   .   P v Q</pre> | I v (L) | 48 |
| 51 |  | <pre>.   .   .   R v S</pre> | I v (R) | 49 |
| 52 |  | <pre>.   .   .   ( P v Q ) ^ ( R v S )</pre> | I ^ | 50, 51 |
| 53 |  | <pre>.   .   ( P ^ S ) -> ( ( P v Q ) ^ ( R v S ) )</pre> | subproof -> | 47 - 52 |
| 54 |  | <pre>.   .   ( P v Q ) ^ ( R v S )</pre> | E v | 46, 53, 39 |
| 55 |  | <pre>.   ( ( P ^ R ) v ( P ^ S ) ) -> ( ( P v Q ) ^ ( R v S ) )</pre> | subproof -> | 39 - 54 |
| 56 |  | <pre>.   .   ( Q ^ R ) v ( Q ^ S )</pre> | Assume: -> |  |
| 57 |  | <pre>.   .   .   Q ^ R</pre> | Assume: -> |  |
| 58 |  | <pre>.   .   .   Q</pre> | E ^ (L) | 57 |
| 59 |  | <pre>.   .   .   R</pre> | E ^ (R) | 57 |
| 60 |  | <pre>.   .   .   P v Q</pre> | I v (R) | 58 |
| 61 |  | <pre>.   .   .   R v S</pre> | I v (L) | 59 |
| 62 |  | <pre>.   .   .   ( P v Q ) ^ ( R v S )</pre> | I ^ | 60, 61 |
| 63 |  | <pre>.   .   ( Q ^ R ) -> ( ( P v Q ) ^ ( R v S ) )</pre> | subproof -> | 57 - 62 |
| 64 |  | <pre>.   .   .   Q ^ S</pre> | Assume: -> |  |
| 65 |  | <pre>.   .   .   Q</pre> | E ^ (L) | 64 |
| 66 |  | <pre>.   .   .   S</pre> | E ^ (R) | 64 |
| 67 |  | <pre>.   .   .   P v Q</pre> | I v (R) | 65 |
| 68 |  | <pre>.   .   .   R v S</pre> | I v (R) | 66 |
| 69 |  | <pre>.   .   .   ( P v Q ) ^ ( R v S )</pre> | I ^ | 67, 68 |
| 70 |  | <pre>.   .   ( Q ^ S ) -> ( ( P v Q ) ^ ( R v S ) )</pre> | subproof -> | 64 - 69 |
| 71 |  | <pre>.   .   ( P v Q ) ^ ( R v S )</pre> | E v | 63, 70, 56 |
| 72 |  | <pre>.   ( ( Q ^ R ) v ( Q ^ S ) ) -> ( ( P v Q ) ^ ( R v S ) )</pre> | subproof -> | 56 - 71 |
| 73 |  | <pre>.   ( P v Q ) ^ ( R v S )</pre> | E v | 55, 72, 38 |
| 74 |  | <pre>( ( ( P ^ R ) v ( P ^ S ) ) v ( ( Q ^ R ) v ( Q ^ S ) ) ) -> ( ( P v Q ) ^ ( R v S ) )</pre> | subproof -> | 38 - 73 |
...
| 12 |  | <pre>.   ( P ^ Q ) -> ( ( ( P v R ) ^ ( P v S ) ) ^ ( ( Q v R ) ^ ( Q v S ) ) )</pre> | subproof -> | 2 - 11 |
| 13 |  | <pre>.   .   R ^ S</pre> | Assume: -> |  |
| 14 |  | <pre>.   .   R</pre> | E ^ (L) | 13 |
| 15 |  | <pre>.   .   S</pre> | E ^ (R) | 13 |
...
| 23 |  | <pre>.   ( R ^ S ) -> ( ( ( P v R ) ^ ( P v S ) ) ^ ( ( Q v R ) ^ ( Q v S ) ) )</pre> | subproof -> | 13 - 22 |
| 24 |  | <pre>.   ( ( P v R ) ^ ( P v S ) ) ^ ( ( Q v R ) ^ ( Q v S ) )</pre> | E v | 12, 23, 1 |
| 25 |  | <pre>( ( P ^ Q ) v ( R ^ S ) ) -> ( ( ( P v R ) ^ ( P v S ) ) ^ ( ( Q v R ) ^ ( Q v S ) ) )</pre> | subproof -> | 1 - 24 |
| 26 |  | <pre>.   ( ( P v R ) ^ ( P v S ) ) ^ ( ( Q v R ) ^ ( Q v S ) )</pre> | Assume: -> |  |
...
| 33 |  | <pre>.   .   P ^ Q</pre> | Assume: -> |  |
| 34 |  | <pre>.   .   ( P ^ Q ) v ( R ^ S )</pre> | I v (L) | 33 |
| 35 |  | <pre>.   ( P ^ Q ) -> ( ( P ^ Q ) v ( R ^ S ) )</pre> | subproof -> | 33 - 34 |
| 36 |  | <pre>.   .   ~ ( P ^ Q )</pre> | Assume: -> |  |
...
| 47 |  | <pre>.   .   ~ P -> ( ( P ^ Q ) v ( R ^ S ) )</pre> | subproof -> | 38 - 46 |
| 48 |  | <pre>.   .   .   ~ Q</pre> | Assume: -> |  |
...
| 57 |  | <pre>.   .   ~ Q -> ( ( P ^ Q ) v ( R ^ S ) )</pre> | subproof -> | 48 - 56 |
| 58 |  | <pre>.   .   ( P ^ Q ) v ( R ^ S )</pre> | E v | 47, 57, 37 |
| 59 |  | <pre>.   ~ ( P ^ Q ) -> ( ( P ^ Q ) v ( R ^ S ) )</pre> | subproof -> | 36 - 58 |
| 60 |  | <pre>.   ( P ^ Q ) v ~ ( P ^ Q )</pre> | Theorem: excluded middle |  |
| 61 |  | <pre>.   ( P ^ Q ) v ( R ^ S )</pre> | E v | 35, 59, 60 |
| 62 |  | <pre>( ( ( P v R ) ^ ( P v S ) ) ^ ( ( Q v R ) ^ ( Q v S ) ) ) -> ( ( P ^ Q ) v ( R ^ S ) )</pre> | subproof -> | 26 - 61 |
...
| 10 |  | <pre>.   P -> ( R v S )</pre> | subproof -> | 6 - 9 |
| 11 |  | <pre>.   .   Q</pre> | Assume: -> |  |
| 12 |  | <pre>.   .   Q -> S</pre> | Reiterate | 5 |
| 13 |  | <pre>.   .   S</pre> | E -> | 12, 11 |
| 14 |  | <pre>.   .   R v S</pre> | I v (R) | 13 |
| 15 |  | <pre>.   Q -> ( R v S )</pre> | subproof -> | 11 - 14 |
| 16 |  | <pre>.   R v S</pre> | E v | 10, 15, 3 |
| 17 |  | <pre>( ( ( P -> R ) ^ ( Q -> S ) ) ^ ( P v Q ) ) -> ( R v S )</pre> | subproof -> | 1 - 16 |
...
| 11 |  | <pre>.   ~ R -> ( ~ P v S )</pre> | subproof -> | 6 - 10 |
| 12 |  | <pre>.   .   Q</pre> | Assume: -> |  |
| 13 |  | <pre>.   .   Q -> S</pre> | Reiterate | 5 |
| 14 |  | <pre>.   .   S</pre> | E -> | 13, 12 |
| 15 |  | <pre>.   .   ~ P v S</pre> | I v (R) | 14 |
| 16 |  | <pre>.   Q -> ( ~ P v S )</pre> | subproof -> | 12 - 15 |
| 17 |  | <pre>.   ~ P v S</pre> | E v | 11, 16, 3 |
| 18 |  | <pre>( ( ( P -> R ) ^ ( Q -> S ) ) ^ ( ~ R v Q ) ) -> ( ~ P v S )</pre> | subproof -> | 1 - 17 |
...
| 4 |  | <pre>.   P</pre> | E ^ (L) | 3 |
| 5 |  | <pre>.   Q</pre> | E ^ (R) | 3 |
| 6 |  | <pre>.   .   P -> R</pre> | Assume: -> |  |
| 7 |  | <pre>.   .   P</pre> | Reiterate | 4 |
| 8 |  | <pre>.   .   R</pre> | E -> | 6, 7 |
| 9 |  | <pre>.   ( P -> R ) -> R</pre> | subproof -> | 6 - 8 |
| 10 |  | <pre>.   .   Q -> R</pre> | Assume: -> |  |
| 11 |  | <pre>.   .   Q</pre> | Reiterate | 5 |
| 12 |  | <pre>.   .   R</pre> | E -> | 10, 11 |
| 13 |  | <pre>.   ( Q -> R ) -> R</pre> | subproof -> | 10 - 12 |
| 14 |  | <pre>.   R</pre> | E v | 9, 13, 2 |
| 15 |  | <pre>( ( ( P -> R ) v ( Q -> R ) ) ^ ( P ^ Q ) ) -> R</pre> | subproof -> | 1 - 14 |
...
| 4 |  | <pre>.   P -> Q</pre> | E <-> (L) | 2 |
| 5 |  | <pre>.   Q</pre> | E -> | 4, 3 |
| 6 |  | <pre>( ( P <-> Q ) ^ P ) -> Q</pre> | subproof -> | 1 - 5 |
...
| 8 |  | <pre>.   .   P</pre> | E -> | 7, 5 |
| 9 |  | <pre>.   ~ Q</pre> | subproof ~ | 5 - 8 |
| 10 |  | <pre>( ( P <-> Q ) ^ ~ P ) -> ~ Q</pre> | subproof -> | 1 - 9 |
...
| 5 |  | <pre>.   ~ P -> Q</pre> | Theorem: contrapositive | 4 |
| 6 |  | <pre>.   ~ P <-> Q</pre> | I <-> | 5, 3 |
| 7 |  | <pre>( P <-> ~ Q ) -> ( ~ P <-> Q )</pre> | subproof -> | 1 - 6 |
...
| 14 |  | <pre>( ~ P <-> ~ Q ) -> ( P <-> Q )</pre> | subproof -> | 8 - 13 |
...
| 5 |  | <pre>.   ~ ( P <-> Q )</pre> | subproof ~ | 2 - 4 |
| 6 |  | <pre>.   ( P <-> Q ) v ~ ( P <-> Q )</pre> | I v (R) | 5 |
| 7 |  | <pre>( P <-> Q ) v ~ ( P <-> Q )</pre> | subproof ~ | 1 - 6 |
...
| 11 |  | <pre>.   P -> ( ( P v Q ) ^ ( ~ P v ~ Q ) )</pre> | subproof -> | 5 - 10 |
| 12 |  | <pre>.   .   ~ P</pre> | Assume: -> |  |
...
| 18 |  | <pre>.   ~ P -> ( ( P v Q ) ^ ( ~ P v ~ Q ) )</pre> | subproof -> | 12 - 17 |
| 19 |  | <pre>.   P v ~ P</pre> | Theorem: excluded middle |  |
| 20 |  | <pre>.   ( P v Q ) ^ ( ~ P v ~ Q )</pre> | E v | 11, 18, 19 |
| 21 |  | <pre>( P <-> ~ Q ) -> ( ( P v Q ) ^ ( ~ P v ~ Q ) )</pre> | subproof -> | 1 - 20 |
| 22 |  | <pre>.   ( P v Q ) ^ ( ~ P v ~ Q )</pre> | Assume: -> |  |
...
| 29 |  | <pre>.   .   ~ ( P ^ Q )</pre> | subproof ~ | 26 - 28 |
| 30 |  | <pre>.   ~ P -> ~ ( P ^ Q )</pre> | subproof -> | 25 - 29 |
| 31 |  | <pre>.   .   ~ Q</pre> | Assume: -> |  |
| 32 |  | <pre>.   .   .   P ^ Q</pre> | Assume: ~ |  |
| 33 |  | <pre>.   .   .   Q</pre> | E ^ (R) | 32 |
| 34 |  | <pre>.   .   .   ~ Q</pre> | Reiterate | 31 |
| 35 |  | <pre>.   .   ~ ( P ^ Q )</pre> | subproof ~ | 32 - 34 |
| 36 |  | <pre>.   ~ Q -> ~ ( P ^ Q )</pre> | subproof -> | 31 - 35 |
| 37 |  | <pre>.   ~ ( P ^ Q )</pre> | E v | 30, 36, 24 |
| 38 |  | <pre>.   .   P</pre> | Assume: -> |  |
| 39 |  | <pre>.   .   .   ~ P ^ ~ Q</pre> | Assume: ~ |  |
| 40 |  | <pre>.   .   .   ~ P</pre> | E ^ (L) | 39 |
| 41 |  | <pre>.   .   .   P</pre> | Reiterate | 38 |
| 42 |  | <pre>.   .   ~ ( ~ P ^ ~ Q )</pre> | subproof ~ | 39 - 41 |
| 43 |  | <pre>.   P -> ~ ( ~ P ^ ~ Q )</pre> | subproof -> | 38 - 42 |
| 44 |  | <pre>.   .   Q</pre> | Assume: -> |  |
| 45 |  | <pre>.   .   .   ~ P ^ ~ Q</pre> | Assume: ~ |  |
| 46 |  | <pre>.   .   .   ~ Q</pre> | E ^ (R) | 45 |
| 47 |  | <pre>.   .   .   Q</pre> | Reiterate | 44 |
| 48 |  | <pre>.   .   ~ ( ~ P ^ ~ Q )</pre> | subproof ~ | 45 - 47 |
| 49 |  | <pre>.   Q -> ~ ( ~ P ^ ~ Q )</pre> | subproof -> | 44 - 48 |
...
| 56 |  | <pre>.   .   ~ Q</pre> | subproof ~ | 52 - 55 |
| 57 |  | <pre>.   P -> ~ Q</pre> | subproof -> | 51 - 56 |
| 58 |  | <pre>.   .   ~ Q</pre> | Assume: -> |  |
| 59 |  | <pre>.   .   .   ~ P</pre> | Assume: ~ |  |
| 60 |  | <pre>.   .   .   ~ Q</pre> | Reiterate | 58 |
| 61 |  | <pre>.   .   .   ~ P ^ ~ Q</pre> | I ^ | 59, 60 |
| 62 |  | <pre>.   .   .   ~ ( ~ P ^ ~ Q )</pre> | Reiterate | 50 |
| 63 |  | <pre>.   .   P</pre> | subproof ~ | 59 - 62 |
| 64 |  | <pre>.   ~ Q -> P</pre> | subproof -> | 58 - 63 |
| 65 |  | <pre>.   P <-> ~ Q</pre> | I <-> | 57, 64 |
| 66 |  | <pre>( ( P v Q ) ^ ( ~ P v ~ Q ) ) -> ( P <-> ~ Q )</pre> | subproof -> | 22 - 65 |
...
| 7 |  | <pre>.   .   P -> R</pre> | subproof -> | 5 - 6 |
| 8 |  | <pre>.   ( P -> Q ) -> ( P -> R )</pre> | subproof -> | 2 - 7 |
| 9 |  | <pre>( ( P -> Q ) -> R ) -> ( ( P -> Q ) -> ( P -> R ) )</pre> | subproof -> | 1 - 8 |
...
| 8 |  | <pre>.   Q</pre> | E ^ (L) | 7 |
| 9 |  | <pre>( P -> Q ) v ( Q -> R )</pre> | subproof ~ | 1 - 8 |
...
| 8 |  | <pre>.   Q</pre> | E ^ (L) | 7 |
| 9 |  | <pre>( P -> Q ) v ( Q -> P )</pre> | subproof ~ | 1 - 8 |
