...
2. [arrows](#arrows)
    ...
    8. [~ ( P -> Q ) -> ( P ^ ~ Q )](#proof-2-8)
    9. [( P ^ ~ Q ) -> ~ ( P -> Q )](#proof-2-9)
    10. [( P v Q ) -> ( ~ P -> Q )](#proof-2-10)
    11. [( ~ P -> Q ) -> ( P v Q )](#proof-2-11)
    12. [( ( P -> Q ) ^ ( P -> ~ Q ) ) -> ~ P](#proof-2-12)
    13. [( ( P -> Q ) ^ ( ~ P -> Q ) ) -> Q](#proof-2-13)
    14. [( P -> Q ) -> ( P -> ( Q v R ) )](#proof-2-14)
    15. [( P -> R ) -> ( ( P ^ Q ) -> R )](#proof-2-15)
    16. [( P -> ( Q -> R ) ) -> ( Q -> ( P -> R ) )](#proof-2-16)
...
5. [distributivity](#distributivity)
    ...
    9. [~ ( P v Q ) -> ( ~ P ^ ~ Q )](#proof-5-9)
    10. [( ~ P ^ ~ Q ) -> ~ ( P v Q )](#proof-5-10)
    11. [~ ( P ^ Q ) -> ( ~ P v ~ Q )](#proof-5-11)
    12. [( ~ P v ~ Q ) -> ~ ( P ^ Q )](#proof-5-12)
...
## ( P -> Q ) -> ( P -> ( Q v R ) ) <a name="proof-2-14"></a>
...
## ( P -> ( Q -> R ) ) -> ( Q -> ( P -> R ) ) <a name="proof-2-16"></a>
...
## ( P v ( Q ^ R ) ) -> ( ( P v Q ) ^ ( P v R ) ) <a name="proof-5-7"></a>
...
## ( ( P v Q ) ^ ( P v R ) ) -> ( P v ( Q ^ R ) ) <a name="proof-5-8"></a>
